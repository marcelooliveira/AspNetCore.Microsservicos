...
namespace CasaDoCodigo.OrdemDeCompra.Commands
{
        ...
        : IRequest<bool>
    {
        ...
        public CreatePedidoCommand(List<CreatePedidoCommandItem> itens, string clienteNome, string clienteEmail, string clienteTelefone, string clienteEndereco, string clienteComplemento, string clienteBairro, string clienteMunicipio, string clienteUF, string clienteCEP)
        {
            Itens = itens;
    ...
    public class CreatePedidoCommandItem
    {
        ...
        public CreatePedidoCommandItem(int produtoId, string produtoCodigo, string produtoNome, decimal produtoPreco, int produtoQuantidade, decimal produtoPrecoUnitario)
        {
            ProdutoId = produtoId;
